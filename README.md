...
En otra terminal, dentro de la carpeta app_frontend (desde la raíz del proyecto: cd .\app_frontend) introduce los siguientes comandos:
...
Ejemplo de uso
Dirígete a http://127.0.0.1:8000/admin/ y verás lo que se muestra en las iguiente imagen.
![alt_text](muestra_app/login_admin_django.png)
...
![alt_text](muestra_app/editar_django.png)
...
![alt_text](muestra_app/crear_paquete_react.png)
